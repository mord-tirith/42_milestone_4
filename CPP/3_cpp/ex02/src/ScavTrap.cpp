...
/*   Updated: 2026/05/04 16:34:53 by thenriqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(const std::string& target) {
	...
	noun = this->guardMode ? " bonks " : " DEMOLISHES ";
	
	std::cout << noun << target << " for " << this->getAttackDamage() << " points of damage!" << std::endl;
	
	if (this->guardMode)
		std::cout << "Damage lessened because " << this->getName() << " is in defensive mode." << std::endl;
...
void	ScavTrap::takeDamage(unsigned int amount) {
	...
	realAmount = this->guardMode ? ((int)(amount * 0.5f)) : amount;

	std::cout << "ScavTrap " << msg << " took " << realAmount << " points of damage!" << std::endl;
	if (this->guardMode)
		std::cout << "Damage halved because " << this->getName() << " is in guard mode!" << std::endl;
	this->setHitPoints(this->getHitPoints() - realAmount);
}
